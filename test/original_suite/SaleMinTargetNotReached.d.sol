...
contract SaleMinTargetNotReachedTest is Test {
    ...
    function setUp() public {
        ...
        merkleProofs[alice][0] = bytes32(0xe9707d0e6171f728f7473c24cc0432a9b07eaaf1efed6a137a4a8c12c79552d9);
        merkleProofs[alice][1] = bytes32(0x347dce04eb339ca70588960730ef0cada966bb1d5e10a9b9489a3e0ba47dc1b6);

        merkleProofs[bob] = new bytes32[](2);
        merkleProofs[bob][0] = bytes32(0x8a3552d60a98e0ade765adddad0a2e420ca9b1eef5f326ba7ab860bb4ea72c94);
        merkleProofs[bob][1] = bytes32(0x070e8db97b197cc0e4a1790c5e6c3667bab32d733db7f815fbe84f5824c7168d);
    ...
    function test_RefundsWhenMinTargetNotReached() public {
        ...
        require(sale.totalUncappedAllocations() == sale.paymentTokenToToken(300 * 1e6));
        require(sale.totalUncappedAllocations() < sale.paymentTokenToToken(sale.minTarget()));
